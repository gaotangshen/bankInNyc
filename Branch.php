...
<?php include 'head_office.php';?>
		<form id="myform" action="#" method="get" name="searchbranch">
			<table>
				...
				<tr>
					...
					<td><a href="insert_branch.php">Insert New Branch</a></td>
				</tr>
			</table>
		</form>
	</div>
	...
	if(isset($_GET[branchname])){
		$sql1 = "select count(*) from branch where name like '%$_GET[branchname]%'";
		...
		$sql = "select * from branch where name like '%$_GET[branchname]%' order by branchID  limit $offset,$pagesize";
