...
if(isset($_POST['zipcode'])){
	...
	$name = "";
	$website="";
	$sql = "select branch.name,address,city,checkingLink,checkingName,summary,minimumBalance,monServiceCharge,benefits,onlineBanking
	from branch,checking where zip > ('$_POST[zipcode]'-10) and zip < ('$_POST[zipcode]'+10) limit 100" ;
			...
			<form id="myform" action="###" method="post" name="zipsubmit">
				<table>
					<tr>
						...
						<td><input style="background-color: blue; height: 25px; color: #ffffff"
